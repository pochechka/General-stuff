...
# %% Гизатуллин_Тимур_Младший_исследователь_данных(DS).ipynb 6
...
# %% Гизатуллин_Тимур_Младший_исследователь_данных(DS).ipynb 20
fig, ax = plt.subplots(ncols = 2, figsize = (20, 10))
fig.set(facecolor = '#eee')
x = np.arange(0, 9, 1)
...
# %% Гизатуллин_Тимур_Младший_исследователь_данных(DS).ipynb 31
